package br.edu.uepb.example.controller;

import java.util.List;
import java.util.Optional;

import br.edu.uepb.example.dto.*; 
import br.edu.uepb.example.domain.*;
import br.edu.uepb.example.repository.*;
...
public class ControllerAluno {
    ...
    public Aluno createAluno(@RequestBody Aluno aluno) {
        ...
        try {
            DTOEmail emailDTO = new DTOEmail("gustavo35867@gmail.com", "Aluno criado", "Aluno foi criado!");
