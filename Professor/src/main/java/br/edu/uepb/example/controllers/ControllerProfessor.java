package br.edu.uepb.example.controllers;

import java.util.List;
import java.util.Optional;

import br.edu.uepb.example.domain.Professor;
import br.edu.uepb.example.dtos.DTOEmail;
import br.edu.uepb.example.repository.RepositoryProfessor;
...
public class ControllerProfessor {
    ...
    public Professor createProfessor(@RequestBody Professor professor) {
        ...
        try {
           DTOEmail emailDTO = new DTOEmail("gustavo35867@gmail.com", "Professor criado", "Sucesso!");
    ...
    public Professor updateProfessor(@PathVariable("id") Long id, @RequestBody Professor professor) {
        ...
        try {
            DTOEmail emailDTO = new DTOEmail("gustavo35867@gmail.com", "Professor Editado", "Sucesso!");
            String json = new ObjectMapper().writeValueAsString(emailDTO);
            Message message = MessageBuilder.withBody(json.getBytes())
                    .setContentType(MessageProperties.CONTENT_TYPE_JSON)
                    .build();
